If (Space 411.usedWebVersion == True) {
	...
	Dialog.show("Space 411 is a service purposely created and developed to feed the public with reliable news about Space and all that comes with
		Space like Astronauts, Planets, Galaxies, etc." + 
